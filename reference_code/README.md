...
├── bootloader-payloads/          # ARM payloads and Docker build system
│   ├── payloads/                 # ARM payload source code
│   └── docker-scripts/           # Docker build and extraction scripts
├── csharp-application/           # C# application components
│   ├── PLCSploit.Core/          # Core library
│   ├── PLCSploit.Cli/           # Command-line interface
│   ├── PLCSploit.Gui/           # GUI application
...
- [Bootloader Payloads Documentation](bootloader-payloads/README.md)
- [C# Application Documentation](csharp-application/README.md)
